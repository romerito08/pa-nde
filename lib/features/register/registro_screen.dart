...
class RegistroScreen extends StatelessWidget {
            ...
            child: Container(
              ...
              child: Center(
                child: SingleChildScrollView(
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start, // Alineado a la izquierda como los inputs
                    children: [
                      // Título Centrado
                      const Center(
                        child: Text(
                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton(
                          ...
                          style: ElevatedButton.styleFrom(
                            backgroundColor: const Color(0xFFE2E600), // El amarillo exacto de pa'onde
                            shape: RoundedRectangleBorder(
                              borderRadius: BorderRadius.circular(6), // Bordes sutiles de Figma
                            ),
                          ),
                          child: const Text(
                            'Registrarse',
                            style: TextStyle(
                              color: Color(0xff1A1F16), // Letras oscuras dentro del botón
                              fontWeight: FontWeight.bold,
                              fontSize: 16,
                              fontFamily: 'Montserrat',
                            ),
                      ...
                      Center(
                        child: Column(
                          children: [
                            ...
                            TextButton(
                              onPressed: () {
                                Navigator.pop(context); // Te regresa a la Landing Page
                              },
                              child: const Text(
                                'Iniciar Sesión',
                                style: TextStyle(
  ...
  // Cajas de texto idénticas a Figma (Bordes rectos/suaves oscuros)
